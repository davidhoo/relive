...
| 问题 | 严重性 | 状态 | 计划版本 |
|------|--------|------|----------|
| API Key 可通过 URL 传递 | 🟠 中 | 已知 | v1.1.0 |
| 容器以 root 运行 | 🟡 低 | 已知 | v1.1.0 |
| 缺少请求频率限制 | 🟡 低 | 已知 | v1.1.0 |
| CORS 包含开发环境域名 | 🟡 低 | 已知 | v1.1.0 |

### 已修复（v1.0.0）

- ✅ 照片访问添加 JWT/API Key 认证
- ✅ SQLite 并发锁竞争优化
- ✅ 代码审查问题修复（Data Race、调试日志等）
...
### v1.0.0 (2026-03-10)
- ✅ 照片访问添加 JWT/API Key 认证
- ✅ SQLite 并发优化（减少 database locked 错误）
