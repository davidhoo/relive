...
[![Status](https://img.shields.io/badge/Status-Backend%20Development-orange)]()
[![Docs](https://img.shields.io/badge/Docs-10k%2B%20lines-blue)]()
[![Go](https://img.shields.io/badge/Go-1.24+-00ADD8?logo=go)]()
[![Backend](https://img.shields.io/badge/Backend-50%25-success)]()
...
**核心特性** ⭐：
- 🚀 **提供者无关**：支持任何 AI 服务（Ollama/Qwen/OpenAI/vLLM）
...
- ✅ 后端基础架构（Repository/Service/Handler 层完成）
- ⏳ AI 分析模块开发中
- 📋 前端开发（计划中）
- 📋 ESP32 固件开发（计划中）
...
**支持多种 AI 提供者**，根据成本/速度/质量灵活选择：

| 提供者 | 类型 | 成本 | 适用场景 |
|--------|------|------|---------|
| **Ollama** | 本地/远程开源模型 | ¥0 | 有 GPU 资源 ✅ |
| **Qwen API** | 阿里云在线 API | ¥2,200 | 追求质量 |
| **OpenAI GPT-4V** | OpenAI 在线 API | ¥3,300 | 最高质量 |
| **vLLM** | 自部署推理服务 | ¥0 | 公司有 GPU 集群 |
| **混合模式** | 多提供者组合 | ¥100-200 | 本地为主，云端兜底 ✅ |

**AI 分析能力**：
- **内容理解**：深度理解照片内容（人物、场景、活动）
