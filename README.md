...
**relive-analyzer** 是专为离线批量分析设计的命令行工具：
...
# 5. 自定义并发数
./relive-analyzer analyze -config configs/analyzer.yaml -db export.db -workers 10
```
...
**详细文档**：查看 [`docs/ANALYZER.md`](docs/ANALYZER.md)
